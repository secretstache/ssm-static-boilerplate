$(document).ready(function() {
    ...
    if(accordion.length) {
        for (let i = 0; i < accordion.length; i++) {  // each accordions 
            if(accordion[i].hasAttribute('data-accordion')) { // check for data-accordion attribute
                let accordionItems = accordion[i].querySelectorAll('.accordion-item');  // accordion items
                ...
                for (let n = 0; n < accordionItems.length; n++) { // for each accordion-item
                    ...
                    currentAccordionTitle.addEventListener("click", function(e) {  // current accordion on click
                        ...
                        if (currentAccordion.classList.contains('active') && !accordion[i].hasAttribute('data-multi-expand')) {
                        ...
                        !accordion[i].hasAttribute('data-multi-expand') ? closeAccordions(accordionItems) : false;
